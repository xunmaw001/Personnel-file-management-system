    ...
    */
    ...
    public R save(@RequestBody BumenEntity bumen, HttpServletRequest request){
        ...
        Wrapper<BumenEntity> queryWrapper = new EntityWrapper<BumenEntity>()
            ...
            .eq("bumen_types", bumen.getBumenTypes())
            .eq("bumen_number", bumen.getBumenNumber())
            .eq("bumen_qiangxiang", bumen.getBumenQiangxiang())
            .eq("bumen_fuzeren", bumen.getBumenFuzeren())
            ;
...
//                            bumenEntity.setBumenTypes(Integer.valueOf(data.get(0)));   //部门类型 要改的
//                            bumenEntity.setBumenNumber(Integer.valueOf(data.get(0)));   //部门人数 要改的
//                            bumenEntity.setBumenQiangxiang(data.get(0));                    //部门强项 要改的
//                            bumenEntity.setBumenFuzeren(data.get(0));                    //部门负责人 要改的
