...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="bumenNameSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <!-- 本表的查询条件 -->
            ...
            //部门名称
            var bumenNameSearchInput = $('#bumenNameSearch');
            if( bumenNameSearchInput != null){
                if (bumenNameSearchInput.val() != null && bumenNameSearchInput.val() != '') {
                    searchForm.bumenName = $('#bumenNameSearch').val();
                }
            }
        ...
        function getDataList() {
            http("bumen/page", "GET", {
                ...
                bumenDelete: 1,
                //本表的
                bumenName: searchForm.bumenName,
        ...
        function setDataRow(item, number) {
            ...
            //部门名称
            var bumenNameCell = document.createElement('td');
            bumenNameCell.innerHTML = item.bumenName;
            row.appendChild(bumenNameCell);
            ...
            //部门人数
            var bumenNumberCell = document.createElement('td');
            bumenNumberCell.innerHTML = item.bumenNumber;
            row.appendChild(bumenNumberCell);


            //部门强项
            var bumenQiangxiangCell = document.createElement('td');
            bumenQiangxiangCell.innerHTML = item.bumenQiangxiang;
            row.appendChild(bumenQiangxiangCell);


            //部门负责人
            var bumenFuzerenCell = document.createElement('td');
            bumenFuzerenCell.innerHTML = item.bumenFuzeren;
            row.appendChild(bumenFuzerenCell);
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addbumen", "addbumen");
            window.location.href = "add-or-update.jsp"
        }
