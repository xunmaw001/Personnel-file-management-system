                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuNewMoneyDiv">
                                        <label>薪资</label>
                                        <input style="width: 450px" id="yonghuNewMoney" name="yonghuNewMoney" class="form-control"
                                               onchange="yonghuNewMoneyChickValue(this)" placeholder="薪资">
                                    </div>
...
<script>
    ...
    //数字检查
        ...
        function yonghuNewMoneyChickValue(e){
            var this_val = e.value || 0;
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yonghuNewMoney").val(ruleForm.yonghuNewMoney);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            // 薪资设置不可选
            $('#yonghuNewMoney').attr('readonly', 'readonly');
        }
        else{
            // alert("未知情况.......");
